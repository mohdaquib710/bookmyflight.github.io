...
<% 
       ...
       Connection con=databasecon.getconnection();
        ...
        String sql="insert into roundtrip1(passname,name,flightid,class,start,arrival,depar,ret,adult,child,infant,price) values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"')";
		
         int x=st.executeUpdate(sql);
		if(x!=0){
		
		response.sendRedirect("makepayround.jsp?message=Successfully Booked");
		}
				else{
			response.sendRedirect("makepayround.jsp?message=fail");
		}
