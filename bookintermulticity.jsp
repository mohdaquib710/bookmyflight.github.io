...
<!--content -->
 ...
 <p><strong><font size="3">AirIndia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;  <img src="images/6.jpg"></font></strong></p>
    ...
    <h3 align="center"><font color="#660000">Book Your International Flights For Multicity</font></h3>
						
    <div class="content" style="border:5px solid #66CCCC"> 
        <div class="tab-content" id="OneWay"> 
          <form id="formID" action="bookinterrmultiinsert.jsp" method="post" onsubmit="return valid();">
         ...
         try      
	{
	   con=databasecon.getconnection();
	    ...
	    String sql="select * from intermulti where id='"+id+"'";
...
<div> 
           ...
           <div class="row"><br>
                ...
                <br>
                <span class="left" >&nbsp;&nbsp;&nbsp;&nbsp;Starting From</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                 <input name="start1" id="start1" value="<%=rs.getString(7)%>" type="text"  style="border:1px solid #3399FF" />
               
				&nbsp;&nbsp;To</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="arrival1" id="arrival1"   value="<%=rs.getString(8)%>" type="text"  style="border:1px solid #3399FF" />
                </div>
              ...
              <div class="row"><br>
			   <p align="right">(Travellers upto 9per Booking)</p>
                ...
                <span class="left" >&nbsp;&nbsp;&nbsp;&nbsp;Departure Date</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                 <input name="depar" id="depar"   value="<%=rs.getString(9)%>" type="text"  style="border:1px solid #3399FF" />
                
				&nbsp;&nbsp;DepartureDate</span>
                <input name="date" id="date"   value="<%=rs.getString(10)%>" type="text"  style="border:1px solid #3399FF" />
                </div>
               ...
               <select name="infant" class="validate[required]" id="infant"  style="font-family:verdana; border:1px solid #3399FF";/>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TotalFare</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="price" id="price"   value="<%=rs.getString(11)%>" type="text"  style="border:1px solid #3399FF" />
                </div>
              <br>
              <br>
