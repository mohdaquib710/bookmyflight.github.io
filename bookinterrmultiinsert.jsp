...
<% 
       ...
       Connection con=databasecon.getconnection();
        ...
        String sql="insert into intermulti1(passname,name,flightid,class,start,arrival,start1,arrival1,depar,date,adult,child,infant,price) values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"','"+m+"','"+n+"')";
		
         int x=st.executeUpdate(sql);
		if(x!=0){
		
		response.sendRedirect("makepaymulti1.jsp?message=Successfully Booked ");
		}
				else{
			response.sendRedirect("makepaymulti1.jsp?message=fail");
		}
