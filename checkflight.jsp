...
<!--content -->
	...
	<section id="content">
		...
		Check Domestic Flights Available</font></h3>				
    <div class="tabs" > 
      <ul class="nav">
      ...
      <div class="content" style="border:5px solid #66CCCC"> 
        <div class="tab-content" id="OneWay"> 
          <form id="formID" action="viewoneway.jsp" method="post" onsubmit="return valid();">
            <div> <br>
              <br>
              ...
              <div class="row"> <span class="left" >&nbsp;&nbsp;&nbsp;&nbsp;Depart</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                Return&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <select name="return" disabled="true"  id="return" style="font-family:verdana; border:1px solid #3399FF";/>
        ...
        <div class="tab-content" id="RoundTrip"> 
          <form id="form" action="viewround.jsp" method="post" onsubmit="return valid();">
            <div> <br>
              <br>
              <div class="row"> <span class="left">&nbsp;&nbsp;&nbsp;&nbsp;Starting 
                From</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              <div class="row"> <span class="left" >&nbsp;&nbsp;&nbsp;&nbsp;Depart</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                Return&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <input value="Choose Return Date" name="return" id="Text5"   class="validate[required]" type="text"  style="border:1px solid #3399FF" />
              ...
              <div class="row"> <br>
                ...
                <option value="6">6</option></select>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Children(2-11)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <select name="child" class="validate[required]" id="child"  style="
                <option value="0">0</option>font-family:verdana; border:1px solid #3399FF";/> 
                  <option value="">Select children</option>
                  <option value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
        ...
        <div class="tab-content" id="MultiCity"> 
          <form id="form1" action="viewmulticity.jsp" method="post" onsubmit="return valid();">
            <div> <br>
              <br>
              <div class="row"> <span class="left">&nbsp;&nbsp;&nbsp;&nbsp;Starting 
                From</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
