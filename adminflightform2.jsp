...
<!--content -->
	...
	<section id="content">
		...
		<div class="for_banners">
			<article class="col1">
			<br><br><br><br><br><br>
		 <h3 align="center"><font color="#660000">International Flights</font></h3>				
    <div class="tabs" > 
      <ul class="nav">
      ...
      <div class="content" style="border:5px solid #66CCCC"> 
        <div class="tab-content" id="OneWay"> 
          <form id="formID" action="interoneinsert.jsp" method="post" onsubmit="return valid();">
            <div> 
              <div class="row"> <br>
                <br>
              ...
              <div class="row"> <span class="left">&nbsp;&nbsp;&nbsp;&nbsp;Class</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                ...
                <option value="PremiumEconomy">PremiumEconomy</option></select> 
              </div>
              <br>
              <br>
        ...
        <div class="tab-content" id="RoundTrip"> 
          <form id="form" action="interroundinsert.jsp" method="post" onsubmit="return valid();">
            <div> 
              <div class="row"> <br>
                <br>
                <span class="left" >&nbsp;&nbsp;&nbsp;&nbsp;FlightName</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        <div class="tab-content" id="MultiCity"> 
          <form id="form1" action="intermultiinsert.jsp" method="post" onsubmit="return valid();">
            <div> 
              <div class="row"> <br>
                <br>
                <span class="left" >&nbsp;&nbsp;&nbsp;&nbsp;FlightName</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
