...
<!--content -->
 ...
 <p><strong><font size="3">AirIndia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;  <img src="images/6.jpg"></font></strong></p>
    ...
    <h3 align="center"><font color="#660000">Book Your International Flights For OneWay</font></h3>
						
    <div class="content" style="border:5px solid #66CCCC"> 
        <div class="tab-content" id="OneWay"> 
          <form id="formID" action="bookinteronewayinsert.jsp" method="post" onsubmit="return valid();">
         ...
         try      
	{
	   con=databasecon.getconnection();
	    ...
	    String sql="select * from interone where id='"+id+"'";
              ...
              <div class="row"><br>
			   <p align="right">(Travellers upto 9per Booking)</p>
                ...
                <option value=">6">>6</option></select>
				 ...
				 <div class="row"><br>
                <br>
                <span class="left" >&nbsp;&nbsp;&nbsp;&nbsp;Children(2-11)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				...
				<div class="row"><br>
                <br>
                <span class="left" >&nbsp;&nbsp;&nbsp;&nbsp;Total Fare</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                 <input name="price" id="price" value="<%=rs.getString(8)%>"   class="validate[required]" type="text"  style="border:1px solid #3399FF" />
                </div>
              <br>
              <br>
